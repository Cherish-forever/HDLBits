...
if __name__ == "__main__":
    ...
    def process():
        ...
        yield Settle()
        assert (yield top.f) == 1, "Test case 1 failed"

        yield top.x.eq(0b0001)
        yield Settle()
        assert (yield top.f) == 1, "Test case 2 failed"
        ...
        yield Settle()
        assert (yield top.f) == 0, "Test case 4 failed"
        ...
        yield Settle()
        assert (yield top.f) == 0, "Test case 12 failed"
        ...
        yield Settle()
        assert (yield top.f) == 1, "Test case 16 failed"
