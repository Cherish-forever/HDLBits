...
if __name__ == "__main__":
    ...
    def process():
        ...
        yield top.d.eq(0)
        yield Settle()
        assert (yield top.out) == 1, "Test case 0 failed"
        ...
        yield top.d.eq(0)
        yield Settle()
        assert (yield top.out) == 0, "Test case 10 failed"
        ...
        yield top.d.eq(0)
        yield Settle()
        assert (yield top.out) == 0, "Test case 12 failed"
        ...
        yield top.d.eq(1)
        yield Settle()
        assert (yield top.out) == 0, "Test case 13 failed"
        ...
        yield top.d.eq(0)
        yield Settle()
        assert (yield top.out) == 0, "Test case 14 failed"
